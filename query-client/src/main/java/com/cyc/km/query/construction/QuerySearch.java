 ...
 * 
 * <p>QueryImpl searches are performed within the context of a {@link CycBasedTask},
...
public class QuerySearch {
  ...
  public static final CycSessionRequirementList<OpenCycUnsupportedFeatureException> 
          QUERY_SEARCH_REQUIREMENTS = CycSessionRequirementList
                  .fromList(NotOpenCycRequirement.NOT_OPENCYC);
  ...
  private abstract class LocationIndex<K> extends HashMap<K, Collection<Span>> {
    ...
    private LocationIndex() {
      super();
      put(null, null); // TODO: Why do we add a null entry? - nwinant, 2017-06-21
    }
