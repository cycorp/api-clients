...
public class QueryConstants {
  ...
  public final KbPredicate SPECIFICATION_DESCRIPTION = KbPredicate.get("specificationDescription");
  
  @CycTerm(cycl="#$nameString")
  public final KbPredicate NAMESTRING = KbPredicate.get("nameString");
  
  @CycTerm(cycl="#$allottedAgents")
  public final KbPredicate ALLOTTED_AGENTS = KbPredicate.get("allottedAgents");
  
  @CycTerm(cycl="#$topicOfIndividual")
  public final KbPredicate TOPIC_OF_INDIVIDUAL = KbPredicate.get("topicOfIndividual");
  
  @CycTerm(cycl="#$CAEAnalysisTask")
  public final KbCollection CAE_ANALYSIS_TASK = KbCollection.get("CAEAnalysisTask");
  
  @CycTerm(cycl="#$CurrentWorldDataCollectorMt-NonHomocentric")
  public final Context CURRENT_WORLD_DATA_COLLECTOR_MT_NON_HOMOCENTRIC = Context.get("CurrentWorldDataCollectorMt-NonHomocentric");
  ...
  public final KbCollection CYCL_QUERY_SPECIFICATION = KbCollection.get("CycLQuerySpecification");
  ...
  private QueryConstants() throws KbTypeException, CreateException {
    ...
    try {
      if (!getCyc().isOpenCyc()) {
        CAE_GUIDANCE_MT_QUERY = KbIndividual.get("CAEGuidanceMtQuery");
      } else {
