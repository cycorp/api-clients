...
public class KbContentLogger {
  ...
  public static final String BASE_KB_LOGGER_NAME = "com.cyc.kb.CONTENT";
  ...
  private static final Logger KB_ASSERTED_LOGGER
          = LoggerFactory.getLogger(BASE_KB_LOGGER_NAME + ".ASSERTED");
  
  private static final Logger KB_CREATED_LOGGER
          = LoggerFactory.getLogger(BASE_KB_LOGGER_NAME + ".CREATED");
  
  private static final Logger KB_DELETED_LOGGER
          = LoggerFactory.getLogger(BASE_KB_LOGGER_NAME + ".DELETED");
  
  private static final Logger KB_EDITED_LOGGER
          = LoggerFactory.getLogger(BASE_KB_LOGGER_NAME + ".EDITED");
