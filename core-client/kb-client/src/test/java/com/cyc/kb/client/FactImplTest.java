...
public class FactImplTest {
  ...
  public void testFactCycObject() throws Exception {
    ...
    FormulaSentence cfs = FormulaSentenceImpl.makeCycSentence(cyc, "(isa Plane-APITest CommercialAircraft)");
  ...
  public void testConstructAssertion() throws KbException {
    ...
    try {
      ...
      KbIndividual expectedDate = KbIndividualFactory.get("(MinuteFn 5 (HourFn 8 (DayFn 15 (MonthFn March (YearFn 2014)))))");
