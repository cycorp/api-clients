...
public class KbObjectImplTest {
  ...
  public void testSetAssertion2() throws KbException {
    final BinaryPredicateImpl physicalParts = BinaryPredicateImpl.get("physicalParts");
  ...
  public void testIsQuoted() throws KbTypeException, CreateException {
    final KbIndividual plato = KbIndividualFactory.get("Plato");
    final KbIndividual quotedPlato = KbIndividualFactory.get("(Quote Plato)");
    final KbIndividual quotedQuotedPlato = KbIndividualFactory.get("(Quote (Quote Plato))");
  ...
  public void testIsQuoted_string() throws KbTypeException, CreateException {
    final KbIndividual quotedPlatoString = KbIndividualFactory.get("(Quote \"Plato\")");
  ...
  public void testQuote_string() throws Exception {
    ...
    final KbIndividual quotedPlatoString = KbIndividualFactory.get("(Quote \"" + platoString + "\")");
    final KbIndividual quotedQuotedPlatoString = KbIndividualFactory.get("(Quote (Quote \"" + platoString + "\"))");
