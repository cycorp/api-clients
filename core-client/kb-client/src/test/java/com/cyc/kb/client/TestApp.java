...
public class TestApp {
  ...
  public void testHelloWorlds() throws Exception {
    ...
    //        "UniverseDataMt");
    Collection<Double> flt = BinaryPredicateImpl.get("orbitalEccentricity")
    ...
    KbIndividual kbDate = KbIndividualFactory.get("(MinuteFn 20 (HourFn 10 (DayFn 15 (MonthFn March (YearFn 2014)))))");
    ...
    Collection<Date> dates = BinaryPredicateImpl.get("endingDate")
