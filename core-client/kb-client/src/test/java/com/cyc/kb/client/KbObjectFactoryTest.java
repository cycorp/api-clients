...
//    FormulaSentence istSentence = CycFormulaSentence.makeCycSentence("(ist LogicalTruthMt (isa Collection Collection))");
  ...
  public void testCacheNoCollisions() throws Exception {
    ...
    Collection<KbIndividual> querySpecCol1 = q1.getValues(testQuerySpecificationPred, 1, 2, testVocabularyCtx);
    Collection<KbIndividual> querySpecCol2 = q2.getValues(testQuerySpecificationPred, 1, 2, testVocabularyCtx);
  ...
  public void testTightenCycObject_FormulaSentence() throws SessionException, CycConnectionException {
    ...
    final CycObject       result   = KbObjectFactory.tightenCycObject(expected.toCycList());
  ...
  public void testGet_CycList_Sentence() throws SessionException, CreateException, KbTypeException {
    ...
    final KbObject expected = KbObjectFactory.get(sent, KbObjectImpl.class);
    final KbObject result   = KbObjectFactory.get(list, KbObjectImpl.class);
    assertEquals(expected, result);
  }
  ...
  public void testGet_CycList_Naut() throws SessionException, CreateException, KbTypeException {
    ...
    final KbObject expected = KbObjectFactory.get(naut, KbObjectImpl.class);
    final KbObject result   = KbObjectFactory.get(list, KbObjectImpl.class);
    assertEquals(expected, result);
  }
