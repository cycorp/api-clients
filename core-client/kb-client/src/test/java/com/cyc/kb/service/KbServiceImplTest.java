...
public class KbServiceImplTest {
  ...
  @Before
  public void setUp() {
    KbClientImpl services = new KbClientImpl();
    instance = services.kb();
  }
  ...
  public void testGetKbObject_Assertion_1() throws Exception {
    ...
    assertEquals(ServiceTestExamplesInKb.FLYING_DONE_BY_PILOT_FACT,
            instance.kbObject(ServiceTestExamplesInKb.FLYING_DONE_BY_PILOT_HLID));
    assertEquals(
            new SentenceImpl(ServiceTestExamplesNotInKb.FLYING_DONE_BY_PILOT_SENTENCE_STRING),
            instance.kbObject(ServiceTestExamplesNotInKb.FLYING_DONE_BY_PILOT_SENTENCE_STRING));
    assertEquals(
            new SentenceImpl(ServiceTestExamplesNotInKb.IST_FLYING_DONE_BY_PILOT_SENTENCE_STRING),
            instance.kbObject(ServiceTestExamplesNotInKb.IST_FLYING_DONE_BY_PILOT_SENTENCE_STRING));
  }
  ...
  public void testGetKbObject_Assertion_2() throws Exception {
    ...
    assertNotEquals(SentenceImpl.get(ServiceTestExamplesNotInKb.FLYING_DONE_BY_PILOT_SENTENCE_STRING),
