...
/*
 * #%L
 * File: FirstOrderCollectionImplTest.java
 * Project: KB Client
 * %%
 ...
 * @author vijay
 */
public class FirstOrderCollectionImplTest {

  public FirstOrderCollectionImplTest() {
  }
  ...
  public void testFirstOrderCollection_Constructors() throws Exception {
    ...
    System.out.println("Facts: " + Constants.isa().getFacts(foc2, 1, Constants.uvMt()));
    foc2.delete();
    try {
  ...
  public void testGeneralizations_String_String() throws Exception {
    ...
    System.out.println("Facts: " + Constants.isa().getFacts(foc1, 1, Constants.uvMt()));
