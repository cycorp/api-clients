...
public interface AssertTool {
   ...
   */
  void assertDefiningMt(final Fort dependentTerm, final Fort mt)
          throws CycConnectionException, CycApiException;
   ...
   * @throws CycApiException if the Cyc server returns an error
   */
  void assertTermDependsOn(final Fort dependentTerm, final Fort independentTerm, final Fort mt) 
          throws CycConnectionException, CycApiException;
   ...
   * @throws CycApiException if the Cyc server returns an error
   */
  CycElMtConstant createCollectorMt(String mtName, String comment, List genlMts)
          throws CycConnectionException, CycApiException;
   ...
   * @throws CycApiException if the api request results in a cyc server error
   */
  CycElMtConstant createMicrotheory(String mtName, String comment, Fort isaMt, List genlMts)
          throws CycConnectionException, CycApiException;
   ...
   * @throws CycApiException if the api request results in a cyc server error
   */
  CycElMtConstant createMicrotheory(
   ...
   * @throws CycApiException if the Cyc server returns an error
   */
  CycElMtConstant createSpindleMt(
