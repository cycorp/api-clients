...
public interface InspectorTool {
   ...
   */
  int countAllInstances(Fort collection, CycObject mt)
   ...
   * @throws CycApiException if the api request results in a cyc server error
   */
  int countAllInstances_Cached(Fort collection, CycObject mt) 
          throws CycConnectionException, CycApiException;
   ...
   */
  boolean isAssertionValid(CycList hlFormula, Fort mt) 
          throws CycConnectionException, CycConnectionException, CycApiException;
   ...
   * @throws CycApiException if the api request results in a cyc server error
   */
  boolean isBackchainDiscouraged(CycConstant predicate, CycObject mt)
          throws CycConnectionException, CycApiException;
   ...
   * @throws CycApiException if the api request results in a cyc server error
   */
  boolean isBackchainEncouraged(CycConstant predicate, CycObject mt)
          throws CycConnectionException, CycApiException;
   ...
   * @throws CycApiException if the api request results in a cyc server error
   */
  boolean isBackchainForbidden(CycConstant predicate, CycObject mt) 
          throws CycConnectionException, CycApiException;
   ...
   * @throws CycApiException if the api request results in a cyc server error
   */
  boolean isBackchainRequired(CycConstant predicate, CycObject mt) 
          throws CycConnectionException, CycApiException;
   ...
   * @throws CycApiException if the api request results in a cyc server error
   */
  boolean isBinaryPredicate(final CycObject cycObject) throws
          CycConnectionException, CycConnectionException, CycApiException;
   ...
   * @throws CycApiException if the api request results in a cyc server error
   */
  boolean isCollection(final CycObject cycObject)
          throws CycConnectionException, CycConnectionException, CycApiException;
   ...
   * @throws CycApiException if the api request results in a cyc server error
   */
  boolean isCollection(final Object obj)
          throws CycConnectionException, CycConnectionException, CycApiException;
   ...
   * @throws CycApiException if the api request results in a cyc server error
   */
  boolean isConstantNameAvailable(String candidateName) 
          throws CycConnectionException, CycConnectionException, CycApiException;
   ...
   * @throws CycApiException if the api request results in a cyc server error
   */
  boolean isCycLNonAtomicReifableTerm(CycObject formula)
          throws CycConnectionException, CycConnectionException, CycApiException;
   ...
   * @throws CycApiException if the api request results in a cyc server error
   */
  boolean isCycLNonAtomicUnreifableTerm(CycObject formula)
          throws CycConnectionException, CycConnectionException, CycApiException;
   ...
   * @throws CycApiException if the api request results in a cyc server error
   */
  boolean isEvaluatablePredicate(Fort predicate) 
          throws CycConnectionException, CycConnectionException, CycApiException;
   ...
   * @throws CycApiException if the api request results in a cyc server error
   */
  boolean isFormulaWellFormed(CycList formula, CycObject mt) 
          throws CycConnectionException, CycConnectionException, CycApiException;
   ...
   * @throws CycApiException if the api request results in a cyc server error
   */
  boolean isFormulaWellFormed(Formula formula, CycObject mt)
          throws CycConnectionException, CycConnectionException, CycApiException;
   ...
   * @throws CycApiException if the api request results in a cyc server error
   */
  boolean isFunction(CycObject cycObj)
          throws CycConnectionException, CycConnectionException, CycApiException;
   ...
   * @throws CycApiException if the api request results in a cyc server error
   */
  boolean isFunctionBound(String symbolName) 
          throws CycConnectionException, CycConnectionException, CycApiException;
   ...
   * @throws CycApiException if the api request results in a cyc server error
   */
  boolean isFunctionBound(CycSymbol cycSymbol)
          throws CycConnectionException, CycConnectionException, CycApiException;
   ...
   * @param mt the candidate assertion microtheory
   */
  boolean isGafValidAssertion(CycList gaf, ElMt mt) 
          throws CycConnectionException, CycConnectionException, CycApiException;
   ...
   * @param mt the candidate assertion microtheory
   */
  boolean isGafValidAssertion(FormulaSentence gaf, ElMt mt) 
          throws CycConnectionException, CycConnectionException, CycApiException;
   ...
   * @throws CycApiException if the api request results in a cyc server error
   */
  boolean isGenlInverseOf(Fort genlPred, Fort specPred, CycObject mt)
          throws CycConnectionException, CycConnectionException, CycApiException;
   ...
   * @throws CycApiException if the api request results in a cyc server error
   */
  boolean isGenlInverseOf(Fort genlPred, Fort specPred)
          throws CycConnectionException, CycConnectionException, CycApiException;
   ...
   * @throws CycApiException if the api request results in a cyc server error
   */
  boolean isGenlMtOf(CycObject genlMt, CycObject specMt)
          throws CycConnectionException, CycConnectionException, CycApiException;
   ...
   * @throws CycApiException if the api request results in a cyc server error
   */
  boolean isGenlOf(CycObject genl, CycObject spec) 
          throws CycConnectionException, CycConnectionException, CycApiException;
   ...
   * @throws CycApiException if the api request results in a cyc server error
   */
  boolean isGenlOf(CycObject genl, CycObject spec, CycObject mt)
          throws CycConnectionException, CycConnectionException, CycApiException;
 ...
 same question twice from the KB.
   ...
   * @throws CycApiException if the api request results in a cyc server error
   */
  boolean isGenlOf_Cached(CycObject genl, CycObject spec)
          throws CycConnectionException, CycConnectionException, CycApiException;
   ...
   * @throws CycApiException if the api request results in a cyc server error
   */
  boolean isGenlPredOf(Fort genlPred, Fort specPred, CycObject mt) 
          throws CycConnectionException, CycConnectionException, CycApiException;
   ...
   * @throws CycApiException if the api request results in a cyc server error
   */
  boolean isGenlPredOf(Fort genlPred, Fort specPred) 
          throws CycConnectionException, CycConnectionException, CycApiException;
   ...
   * @throws CycApiException if the api request results in a cyc server error
   */
  boolean isIndividual(final CycObject cycObject) 
          throws CycConnectionException, CycConnectionException, CycApiException;
   ...
   * @throws CycApiException if the api request results in a cyc server error
   */
  boolean isIrreflexivePredicate(CycConstant predicate, CycObject mt) 
          throws CycConnectionException, CycApiException;
   ...
   * @throws CycApiException if the api request results in a cyc server error
   */
  boolean isMicrotheory(CycObject term)
          throws CycConnectionException, CycConnectionException, CycApiException;
   ...
   * @throws CycApiException if the api request results in a cyc server error
   */
  boolean isPredicate(CycObject cycObject)
          throws CycConnectionException, CycConnectionException, CycApiException;
   ...
   * @throws CycApiException if the api request results in a cyc server error
   */
  boolean isPredicate(final Object object) 
          throws CycConnectionException, CycConnectionException, CycApiException;
   ...
   */
  @Deprecated
  boolean isQuotedCollection(Fort cycFort) 
          throws CycConnectionException, CycConnectionException, CycApiException;
   ...
   */
  @Deprecated
  boolean isQuotedCollection(Fort cycFort, CycObject mt) 
          throws CycConnectionException, CycConnectionException, CycApiException;
   ...
   * @throws CycApiException if the api request results in a cyc server error
   */
  boolean isQuotedIsa(final CycObject term, final CycObject collection) 
 ...
 in the given inference microtheory.
   ...
   * @throws CycApiException if the api request results in a cyc server error
   */
  boolean isQuotedIsa(final CycObject term, final CycObject collection, final CycObject mt)
          throws CycConnectionException, 
          CycConnectionException,
          CycApiException,
          CycTimeOutException;
   ...
   * @throws CycApiException if the api request results in a cyc server error
   */
  boolean isReifiableFunction(CycObject cycObj)
          throws CycConnectionException, CycConnectionException, CycApiException;
   ...
   * @throws CycApiException if the api request results in a cyc server error
   */
  boolean isSpecOf(CycObject spec, CycObject genl) 
          throws CycConnectionException, CycConnectionException, CycApiException;
   ...
   * @throws CycApiException if the api request results in a cyc server error
   */
  boolean isSpecOf(CycObject spec, CycObject genl, CycObject mt)
          throws CycConnectionException, CycConnectionException, CycApiException;
   ...
   * @throws CycApiException if the api request results in a cyc server error
   */
  boolean isUnaryPredicate(CycObject cycObject) 
          throws CycConnectionException, CycConnectionException, CycApiException;
   ...
   * @throws CycApiException if the api request results in a cyc server error
   */
  boolean isValidConstantName(String candidateName) 
          throws CycConnectionException, CycConnectionException, CycApiException;
   ...
   * @throws CycApiException if the api request results in a cyc server error
   */
  boolean isWellFormedFormula(Formula formula) 
          throws CycConnectionException, CycConnectionException, CycApiException;
 ...
 microtheories.
   ...
   * @throws CycApiException if the api request results in a cyc server error
   */
  boolean isa(CycObject term, String collectionName) 
          throws CycConnectionException, CycConnectionException, CycApiException;
 ...
 microtheories.
   ...
   * @throws CycApiException if the api request results in a cyc server error
   */
  boolean isa(CycObject term, Fort collection) 
          throws CycConnectionException, CycConnectionException, CycApiException;
   ...
   * @throws CycApiException if the api request results in a cyc server error
   */
  boolean isa(CycObject term, CycObject collection, CycObject mt) 
          throws CycConnectionException, CycConnectionException, CycApiException;
