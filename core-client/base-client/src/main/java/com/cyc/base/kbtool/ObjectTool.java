...
public interface ObjectTool {
   ...
   * Constructs a new ElMt object by the given CycObject.
   * 
   * @note    this is redundant with the {@link #makeElMt(java.lang.Object) }, but is left in for 
   *          compatability
   ...
   * @throws  CycApiException         if the api request results in a cyc server error
   */
  CycConstant makeUniqueCycConstant(final String startName)
   ...
   * @throws  CycApiException         if the api request results in a cyc server error
   */
  void rename(final CycConstant cycConstant, final String newName) 
