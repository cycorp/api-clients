 ...
 * @version $Id: SublCommandProfiler.java 170971 2017-03-16 01:34:00Z nwinant $
 */
public class SublCommandProfiler implements WorkerListener {
  
  private static final Logger LOGGER = LoggerFactory.getLogger(SublCommandProfiler.class);
 ...
 processing of a SubL task.
  ...
  public void notifySubLWorkerStarted(WorkerEvent event) {
    ...
    LOGGER.debug(event.getWorker().getSubLCommand().toPrettyCyclifiedString(""));
  }
