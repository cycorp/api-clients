...
public class TestSentences {
  ...
  public static final FormulaSentence ISA_WILLIAM_HENRY_HARRISON_US_PRESIDENT
          = FormulaSentenceImpl.makeCycFormulaSentence(ISA, WILLIAM_HENRY_HARRISON,
                  new NautImpl(
                          FORMER_FN,
  ...
  public static final FormulaSentence genlsWilliamHenryHarrisonBLO =
          FormulaSentenceImpl.makeCycFormulaSentence(GENLS, WILLIAM_HENRY_HARRISON, BIOLOGICAL_LIVING_OBJECT);
  ...
  public static final FormulaSentence isaWilliamHenryHarrisonBLO =
          FormulaSentenceImpl.makeCycFormulaSentence(ISA, WILLIAM_HENRY_HARRISON, BIOLOGICAL_LIVING_OBJECT);
  ...
  public static final FormulaSentence WHAT_IS_ONE_PLUS_ONE =
          FormulaSentenceImpl.makeCycFormulaSentence(EVALUATE, VAR_X, 
                  FormulaSentenceImpl.makeCycFormulaSentence(PLUS_FN, 1, 1));
  ...
  public static final FormulaSentence WHAT_IS_IN_AUSTIN =
          FormulaSentenceImpl.makeCycFormulaSentence(OBJECT_FOUND_IN_LOCATION, VAR_WHAT, CITY_OF_AUSTIN_TX);
  ...
  public static final FormulaSentence isaThingThing =
          FormulaSentenceImpl.makeCycFormulaSentence(ISA, THING, THING);
  ...
  public static final FormulaSentence ISA_DOG_BIOLOGICAL_SPECIES =
          FormulaSentenceImpl.makeCycFormulaSentence(ISA, DOG, BIOLOGICAL_SPECIES);
  ...
  public static final FormulaSentence CATS_LIKE_CYC_ADMIN =
          FormulaSentenceImpl.makeCycFormulaSentence(IMPLIES, 
                  FormulaSentenceImpl.makeCycFormulaSentence(ISA, VAR_X, CAT),
                  FormulaSentenceImpl.makeCycFormulaSentence(LIKES_AS_FRIEND, VAR_X, CYC_ADMINISTRATOR));  
  ...
  public static final FormulaSentence THE_DOG =
          FormulaSentenceImpl.makeCycFormulaSentence(THE, DOG);
  ...
  public static final FormulaSentence ISA_THE_DOG_DOG =
          FormulaSentenceImpl.makeCycFormulaSentence(ISA, THE_DOG, DOG);
  ...
  public static final FormulaSentence ISA_MUFFET_DOG =
          FormulaSentenceImpl.makeCycFormulaSentence(ISA, MUFFET, DOG);
  ...
  public static final FormulaSentence MT_SPACE_CYCLISTS_MT_TIME_POINT
          = FormulaSentenceImpl.makeCycFormulaSentence(MT_SPACE, CYCLISTS_MT,
                  FormulaSentenceImpl.makeCycFormulaSentence(MT_TIME_POINT_WITH_GRANULARITY_DIM_FN,
                          FormulaSentenceImpl.makeCycFormulaSentence(MONTH_FN, DateConverter.JANUARY,
                                  FormulaSentenceImpl.makeCycFormulaSentence(YEAR_FN, 2004)),
                          TIME_POINT));
  ...
  */
  ...
  @CycFormula(cycl="(#$BiologicalTaxon "
              ...
              + "#$CollectionType)",
          optional=true)
  public static final FormulaSentence BIOLOGICAL_TAXON_ETC = FormulaSentenceImpl.makeCycFormulaSentence(
            BIOLOGICAL_TAXON,
            BIOLOGICAL_SPECIES,
  ...
  public static final FormulaSentence UNKNOWN_SENTENCE_FOOD_ORG = FormulaSentenceImpl.makeCycFormulaSentence(UNKNOWN_SENTENCE,
          FormulaSentenceImpl.makeCycFormulaSentence(
                  ISA,
                  VAR_WHAT,
                  FOOD_SERVICE_ORGANIZATION));
  
  @CycFormula(cycl="(#$objectFoundInLocation ?WHAT ?WHERE)")
  public static final FormulaSentence OBJECT_FOUND_WHAT_WHERE = FormulaSentenceImpl.makeCycFormulaSentence(
          OBJECT_FOUND_IN_LOCATION,
          VAR_WHAT,
          VAR_WHERE);
  
  @CycFormula(cycl="(#$objectFoundInLocation #$UniversityOfTexasAtAustin #$CityOfAustinTX)")
  public static final FormulaSentence UT_AUSTIN_IN_AUSTIN = FormulaSentenceImpl.makeCycFormulaSentence(
          OBJECT_FOUND_IN_LOCATION,
          UT_AUSTIN,
          CITY_OF_AUSTIN_TX);
  
  @CycFormula(cycl="(#$objectFoundInLocation #$UniversityOfTexasAtAustin #$CityOfHoustonTX)")
  public static final FormulaSentence UT_AUSTIN_IN_HOUSTON = FormulaSentenceImpl.makeCycFormulaSentence(
          OBJECT_FOUND_IN_LOCATION,
          UT_AUSTIN,
          CITY_OF_HOUSTON_TX);
  
  @CycFormula(cycl="(#$isa #$CycAdministrator #$Person)")
  public static final FormulaSentence ISA_CYC_ADMIN_PERSON = FormulaSentenceImpl.makeCycFormulaSentence(
          ISA,
          CYC_ADMINISTRATOR,
          PERSON);
  
  @CycFormula(cycl="(#$isa (#$DayFn 1 (#$MonthFn #$March (#$YearFn 2004))) #$Event)")
  public static final FormulaSentence DAY_MARCH_1_2004_EVENT = FormulaSentenceImpl.makeCycFormulaSentence(ISA,
          FormulaSentenceImpl.makeCycFormulaSentence(DAY_FN, 1,
                  FormulaSentenceImpl.makeCycFormulaSentence(MONTH_FN, MARCH,
                          FormulaSentenceImpl.makeCycFormulaSentence(YEAR_FN, 2004))),
          EVENT);
  
  @CycFormula(cycl="(#$isa (#$DayFn 1 (#$MonthFn #$March (#$YearFn 2004))) #$CalendarDay)")
  public static final FormulaSentence DAY_MARCH_1_2004_CALENDAR_DAY = FormulaSentenceImpl.makeCycFormulaSentence(ISA,
          FormulaSentenceImpl.makeCycFormulaSentence(DAY_FN, 1,
                  FormulaSentenceImpl.makeCycFormulaSentence(MONTH_FN, MARCH,
                          FormulaSentenceImpl.makeCycFormulaSentence(YEAR_FN, 2004))),
          CALENDAR_DAY);
  ...
  @CycFormula(cycl = "(#$TheCovering #$Watercraft-Surface #$Watercraft-Subsurface)",
          optional=true)
  public static final FormulaSentence WATERCRAFT_COVERING= FormulaSentenceImpl.makeCycFormulaSentence(
          THE_COVERING,
          WATERCRAFT_SURFACE,
  ...
  @CycFormula(cycl="(#$LexicalMtForLanguageFn #$AzeriLanguage)",
          optional=true)
  public static final FormulaSentence AZERI_LANGUAGE_LEXICAL_MT = FormulaSentenceImpl.makeCycFormulaSentence(
          LEXICAL_MT_FOR_LANGUAGE_FN, AZERI_LANGUAGE);
    
  @CycFormula(cycl="(#$MtSpace #$BaseKB (#$MtTimeDimFn #$Now))",
          optional=true)
  public static final FormulaSentence MT_SPACE_TIME_NOW = FormulaSentenceImpl.makeCycFormulaSentence(MT_SPACE, 
          BASE_KB,
          FormulaSentenceImpl.makeCycFormulaSentence(
                  MT_TIME_DM_FN,
                  NOW));
  ...
  @CycFormula(cycl="(#$MtSpace #$BaseKB (#$MtTimeWithGranularityDimFn #$Always-TimeInterval #$Null-TimeParameter))",
          optional=true)
  public static final FormulaSentence MT_SPACE_TIME_ALWAYS = FormulaSentenceImpl.makeCycFormulaSentence(MT_SPACE, 
          BASE_KB,
          FormulaSentenceImpl.makeCycFormulaSentence(
