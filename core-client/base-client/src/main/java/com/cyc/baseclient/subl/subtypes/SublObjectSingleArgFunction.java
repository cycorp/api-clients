...
/*
 * #%L
 * File: SublObjectSingleArgFunction.java
 * Project: Base Client
 * %%
 ...
 */
public class SublObjectSingleArgFunction<T extends Object> extends AbstractSublSingleArgFunction<T, Object> {
   ...
   * @param name
   */
  public SublObjectSingleArgFunction(String name) {
    super(name);
  }
   ...
   */
  @Override
  public Object eval(CycAccess access, T arg) throws CycConnectionException, CycApiException {
    return access.converse().converseObject(buildCommand(arg));
  }
