...
/*
 * #%L
 * File: FormulaSentenceTestImpl.java
 * Project: Base Client
 * %%
...
import static com.cyc.baseclient.cycobject.FormulaSentenceImpl.*;
 ...
 * @author daves
 */
public class FormulaSentenceTestImpl {

  public FormulaSentenceTestImpl() {
  }
  ...
  /**
   * Test of makeCycFormulaSentence method, of class FormulaSentenceImpl.
   */
  @Test
  ...
  public void testConvertIfPromising() {
    ...
    assertTrue(convertIfPromising(CycArrayList.makeCycList(ISA, THING, THING)) instanceof FormulaSentenceImpl);
  }
  ...
  /**
   * Test of makeCycSentence method, of class FormulaSentenceImpl.
   */
  @Test
  ...
  public void testFindIndexicals() throws CycApiException, CycConnectionException {
    final String sentenceStr
            ...
            + "  \"Some random string\""
            + "  ?VAR2)";
    final FormulaSentence sentence = FormulaSentenceImpl.makeCycSentence(getCyc(), sentenceStr);
  ...
  public void testHashCode() throws CycConnectionException {
    ...
    FormulaSentence f1 = FormulaSentenceImpl.makeCycSentence(access, str1);
    FormulaSentence f2 = FormulaSentenceImpl.makeCycSentence(access, str2);
    /*
