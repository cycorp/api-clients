...
public class TestUtils {
  ...
  public static CycElMtConstant TEST_MT = null;
  ...
  public static CycElMtConstant recreateTestMt(CycAccess access) throws CycConnectionException {
    TEST_MT = access.getAssertTool().createMicrotheory(
            "TestMt", "Test microtheory", "Microtheory", new ArrayList());
    return TEST_MT;
  }

  synchronized public static void ensureKBPopulated(CycAccess access)
          throws CycConnectionException, SessionException {
    if (TEST_MT == null) {
      recreateTestMt(access);
    }
  ...
  public static void ensureTestEnvironmentInitialized() 
          throws SessionException, CycConnectionException {
