...
public class CycServerTest {
  ...
  public void isValidString() {
    assertTrue(CycServer.isValidString("fredscomputer:40"));
    assertTrue(CycServer.isValidString("fredscomputer:4000"));
    assertTrue(CycServer.isValidString("fredscomputer:40000"));
    assertFalse(CycServer.isValidString("fredscomputer:400000"));
    assertFalse(CycServer.isValidString("fredscomputer"));
  }
