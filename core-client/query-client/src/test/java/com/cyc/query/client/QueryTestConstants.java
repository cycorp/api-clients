...
public class QueryTestConstants {
  ...
  @CycTerm(cycl = "#$Plant")
  public final KbCollection plant = KbCollectionImpl.get("Plant");

  @CycTerm(cycl = "#$Animal")
  private final KbCollection animal = KbCollectionImpl.get("Animal");
  ...
  public final Sentence yOwnsX = new SentenceImpl(BinaryPredicateImpl.get("owns"),
  ...
  public final KbPredicate testAnswersCardinalityMin = KbPredicateImpl.get(
