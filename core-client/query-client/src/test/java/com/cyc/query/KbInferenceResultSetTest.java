...
public class KbInferenceResultSetTest {
  ...
  private void resetQ() throws QueryConstructionException, KbRuntimeException {
    currentQuery = QueryFactory.getQuery(testConstants().genlsAnimalX, Constants.inferencePSCMt());
  }
  ...
  public void testGetCurrentRowCount() throws QueryConstructionException, KbException {
    ...
    currentQuery = QueryFactory.getQuery(equalsXTrue, INFERENCE_PSC);
    QueryResultSet resultSet = currentQuery.getResultSet();
    int result = resultSet.getCurrentRowCount();
    assertEquals(1, result);
    resultSet.close();

    currentQuery = QueryFactory.getQuery(genlsThingThing, INFERENCE_PSC);
  ...
  public void testGetString_int() throws QueryConstructionException {
    ...
    currentQuery = QueryFactory.getQuery(commentBillClintonX, INFERENCE_PSC);
    QueryResultSet resultSet = currentQuery.getResultSet();
    resultSet.next();
  ...
  public void testGetInt_int() throws QueryConstructionException {
    ...
    currentQuery = QueryFactory.getQuery(evaluateThreeMinusOne, INFERENCE_PSC);
    int columnIndex = 1;
    QueryResultSet resultSet = currentQuery.getResultSet();
    resultSet.next();
    int expResult = 2;
  ...
  public void testGetInt_String() throws QueryConstructionException {
    System.out.println("getInt");
    currentQuery = QueryFactory.getQuery("(evaluate ?X (DifferenceFn 3 1))");
    QueryResultSet resultSet = currentQuery.getResultSet();
    resultSet.next();
    int expResult = 2;
  ...
  public void testGetFloat_int() throws QueryConstructionException {
    ...
    currentQuery = QueryFactory.getQuery(evaluateOneMinusPointFive, Constants.baseKbMt());
    int columnIndex = 1;
    QueryResultSet resultSet = currentQuery.getResultSet();
    resultSet.next();
  ...
  public void testGetBoolean_String() throws QueryConstructionException {
    System.out.println("getBoolean");
    currentQuery = QueryFactory.getQuery("(equals ?X True)");
    String var = "?X";
    QueryResultSet resultSet = currentQuery.getResultSet();
    resultSet.next();
    boolean expResult = true;
