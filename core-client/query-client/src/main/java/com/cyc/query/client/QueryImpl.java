...
public class QueryImpl implements Query, Closeable {
  ...
  public static final CycSessionRequirementList<OpenCycUnsupportedFeatureException> QUERY_COMPARISON_REQUIREMENTS
          = CycSessionRequirementList.fromList(
  ...
  private static final Set<QueryImpl> UNCLOSED_QUERIES = Collections.newSetFromMap(new ConcurrentHashMap<QueryImpl, Boolean>());
   ...
   */
  @Deprecated
  static QueryImpl loadCycObjectMap(KbIndividual id, Map<CycObject, Object> indexicals) throws UnsupportedCycOperationException, QueryConstructionException, KbException {
  ...
  private static void replaceIndexicals(Map<String, String> indexicals, QueryImpl q) {
    Map<CycObject, Object> idx = new HashMap<>();
  ...
  private static FormulaSentenceImpl constructSentence(String queryStr) throws QueryConstructionException {
    try {
  ...
  public Query setSubstitutions(Map<KbObject, Object> substitutions) {
    ...
    final Map<CycObject, Object> kboToCoMap = KbUtils.convertKBObjectMapToCoObjectMap(this.substitutions);
