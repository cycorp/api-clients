...
/**
 * Provides an immutable set of session options to serve as defaults for 
...
public class DefaultSessionOptionsImpl implements DefaultSessionOptions {
  ...
  private final String cyclist;
  private final String project;
  private final DefaultContext defaultContext;
  private final Boolean shouldTranscriptOperations;
  
  
  // Construction
  
  public DefaultSessionOptionsImpl() {
