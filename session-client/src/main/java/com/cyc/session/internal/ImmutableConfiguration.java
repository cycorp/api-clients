...
public class ImmutableConfiguration extends AbstractSessionConfigurationProperties implements CycSessionConfiguration {
  ...
  public ImmutableConfiguration(CycAddress server, Class loaderClass) throws SessionConfigurationException {
  ...
  public boolean isServerReleasedWhenAllSessionsAreClosed() {
    //TODO: should default be true?
    return getBooleanProperty(SERVER_RELEASED_WHEN_ALL_SESSIONS_CLOSED, false);
  }
