...
public class ConfigurationValidatorTest extends TestCase {
  ...
  protected void setUp() throws Exception {
    ...
    serverOnlyProps.setProperty(CycSessionConfigurationProperties.SERVER_KEY, "testserver:3640");
  ...
  protected CycSessionConfiguration loadProperties(Properties props) throws SessionConfigurationException {
    ...
    CycSessionConfiguration config = propLoader.getSessionConfiguration(props);
