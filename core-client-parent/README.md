...
The APIs may be used without Maven via the `cyc-core-client-impl-1.0.0-jar-with-dependencies.jar`.
...
The bundle is available from the [releases page](https://github.com/cycorp/api-clients/releases/)
