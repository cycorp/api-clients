...
public class ApiDemo {
  ...
  protected void demoInteraction() {
    Log.current.println("Ready.  Enter demo number 1 ... " + NUM_DEMOS + ", or exit");
   ...
   * /
  protected void demo17() throws CycConnectionException, CycApiException, OpenCycUnsupportedFeatureException {
    if (cycAccess.isOpenCyc()) {
      Log.current.println("\nThis demo is not available in OpenCyc");
    }
    else {
  ...
  */
  ...
  //public static final int NUM_DEMOS = 17;
  public static final int NUM_DEMOS = 16;
