...
/*
 * #%L
 * File: CycAssertionImplTest.java
 * Project: Base Client
 * %%
 ...
 * @author baxter
 */
public class CycAssertionImplTest {

  private CycAssertion assertion;

  public CycAssertionImplTest() {
  }
  ...
  public void testHashCode() {
    ...
    assertTrue(new HashSet<>(Arrays.asList(assertion)).contains(assertion2));
