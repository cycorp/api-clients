...
public class SimpleKbTransactionTest {
    ...
    private static final Logger LOGGER = LoggerFactory.getLogger(SimpleKbTransactionTest.class);
    ...
    public void testCommit() throws CycConnectionException {
        ...
        try {
            ...
            cyc.getAssertTool().assertGaf(FormulaSentenceImpl.makeFormulaSentence(cyc, "(" + isa + " #$commitTestConstant2 " + predicate + ")"), CommonConstants.BASE_KB);
            ...
            cyc.getUnassertTool().unassertGaf(FormulaSentenceImpl.makeFormulaSentence(cyc, "(" + isa + " #$commitTestConstant2 " + predicate + ")"), CommonConstants.BASE_KB);
            ...
            cyc.getAssertTool().assertGaf(FormulaSentenceImpl.makeFormulaSentence(cyc, "(" + isa + " #$commitTestConstant " + predicate + ")"), CommonConstants.BASE_KB);
 ...
 correctly rolled back.
    ...
    public void testCommitFailure() throws CycConnectionException {
        ...
        try {
            ...
            cyc.getAssertTool().assertGaf(FormulaSentenceImpl.makeFormulaSentence(cyc, "(" + isa + " #$commitTestConstant2 " + binaryPredicate + ")"), CommonConstants.BASE_KB);

            commitTestConstant = cyc.getAssertTool().findOrCreateNewPermanent("commitTestConstant");
            cyc.getAssertTool().assertGaf(FormulaSentenceImpl.makeFormulaSentence(cyc, "(" + isa + " #$commitTestConstant " + predicate + ")"), CommonConstants.BASE_KB);
            cyc.getAssertTool().assertGaf(FormulaSentenceImpl.makeFormulaSentence(cyc, "(" + isa + " #$commitTestConstant " + isa + ")"), CommonConstants.BASE_KB);
            assertFalse("commitTestConstant is known to be a predicate before the transaction has been committed.", cyc.getInspectorTool().isPredicate(commitTestConstant));
            Exception ex = null;
            try {
                instance.commit();
