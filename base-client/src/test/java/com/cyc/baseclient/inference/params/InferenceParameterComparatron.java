...
public class InferenceParameterComparatron {
  ...
  public InferenceParameterComparatron(final CycAddress rcycAddress, final CycAddress ocycAddress, long timeoutMsecs) throws SessionException {
  ...
  public InferenceParameterComparatron(final String rcycAddress, final String ocycAddress, long timeoutMsecs) throws SessionException {
    this(CycAddress.fromString(rcycAddress), CycAddress.fromString(ocycAddress), timeoutMsecs);
  }
  ...
  public void printResults() throws SessionException {
    ...
    System.out.println();
    System.out.println("ResearchCyc : " + this.rcyc.getServerInfo().getCycAddress());
    ...
    System.out.println();
    System.out.println("OpenCyc     : " + this.ocyc.getServerInfo().getCycAddress());
