...
public class InferenceParameterOCycRCycComparisonTest {
  ...
  private CycAddress getResearchCycServer() {
    return CycAddress.fromString("localhost:3620");
  }
  
  private CycAddress getOpenCycServer() {
    return CycAddress.fromString("localhost:3600");
  }
