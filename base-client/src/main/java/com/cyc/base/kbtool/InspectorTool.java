...
public interface InspectorTool {
   ...
   * @return whether assertion is valid
   * 
   * @throws CycConnectionException if a data communication error occurs
   * @throws CycApiException if the api request results in a cyc server error
   */
 ...
 same question twice from the KB.
   ...
   * @throws CycApiException if the api request results in a cyc server error
   */
  boolean isIndividual(CycObject cycObject) 
          throws CycConnectionException, CycApiException;
   ...
   * @throws CycApiException if the api request results in a cyc server error
   */
  boolean isPredicate(Object object) 
          throws CycConnectionException, CycApiException;
  ...
  //  boolean isPublicConstant(CycConstant cycConstant) throws CycConnectionException, CycApiException;
   ...
   * @throws CycApiException if the api request results in a cyc server error
   */
  boolean isQuotedIsa(CycObject term, CycObject collection) 
 ...
 in the given inference microtheory.
   ...
   * @throws CycApiException if the api request results in a cyc server error
   */
  boolean isQuotedIsa(CycObject term, CycObject collection, CycObject mt)
          throws CycConnectionException, 
          CycConnectionException,
          CycApiException,
          CycTimeOutException;
