...
public interface UnassertTool {
   ...
   */
  void kill(CycConstant[] cycConstants) throws CycConnectionException, CycApiException;
   ...
   * @throws CycApiException if the api request results in a cyc server error
   */
  void kill(List cycConstants) throws CycConnectionException, CycApiException;
   ...
   * @throws CycApiException if the api request results in a cyc server error
   */
  void kill(Fort cycFort) throws CycConnectionException, CycApiException;
   ...
   * @throws CycApiException if the api request results in a cyc server error
   */
  void kill(Fort cycFort, boolean bookkeeping, boolean transcript)
   ...
   * @throws CycApiException if the api request results in a cyc server error
   */
  void killWithoutTranscript(CycConstant cycConstant) 
          throws CycConnectionException, CycApiException;
   ...
   * @throws CycApiException if the api request results in a cyc server error
   */
  void unassertAssertion(CycAssertion assertion, boolean bookkeeping, boolean transcript)
          throws CycConnectionException, CycApiException;
   ...
   * 
   *<p>Deprecated: Forcing the deletion of an assertion from the KB may have unintended consequences, and should be 
   ...
   */
  @Deprecated
  void blastAssertion(CycAssertion assertion, boolean bookkeeping, boolean transcript)
          throws CycConnectionException, CycApiException;
   ...
   * @throws CycApiException if the api request results in a cyc server error
   */
  void unassertGaf(CycList gaf, CycObject mt) throws CycConnectionException, CycApiException;
   ...
   * @throws CycApiException if the api request results in a cyc server error
   */
  void unassertGaf(FormulaSentence gaf, CycObject mt) 
          throws CycConnectionException, CycApiException;
   ...
   * @throws CycApiException if the api request results in a cyc server error
   */
  void unassertGaf(FormulaSentence gaf, CycObject mt, boolean bookkeeping, boolean transcript)
          throws CycConnectionException, CycApiException;
   ...
   * @throws CycApiException if the Cyc server returns an error
   */
  void unassertMtContentsWithTranscript(CycObject mt)
          throws CycConnectionException, CycApiException;
   ...
   * @throws CycApiException if the Cyc server returns an error
   */
  void unassertMtContentsWithoutTranscript(CycObject mt) 
          throws CycConnectionException, CycApiException;
   ...
   * @throws CycApiException if the api request results in a cyc server error
   */
  void unassertWithBookkeepingAndWithoutTranscript(CycList sentence, CycObject mt) 
          throws CycConnectionException, CycApiException;
}
