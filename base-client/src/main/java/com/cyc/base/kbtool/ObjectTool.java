...
public interface ObjectTool {
   ...
   * @throws CycApiException if the Cyc server returns an error
   */
  Object getELCycTerm(String string) throws CycConnectionException, CycApiException;
   ...
   * @throws CycApiException if the api request results in a cyc server error
   */
  CycConstant makeCycConstant(String name) throws CycConnectionException, CycApiException;
   ...
   * @throws CycApiException if the api request results in a cyc server error
   */
  CycConstant makeCycConstant(String name, boolean bookkeeping, boolean transcript) throws CycConnectionException, CycApiException;
   ...
   * @throws CycApiException if the api request results in a cyc server error
   */
  FormulaSentence makeCyclifiedSentence(String string) throws CycApiException, CycConnectionException;
   ...
   * Constructs a new ElMt object by the given CycObject.
   * 
   * <p>NOTE: this is redundant with the {@link #makeElMt(java.lang.Object) }, but is left in for 
   * compatability.
   * 
   ...
   * @throws  CycApiException         if the api request results in a cyc server error
   */
  CycConstant makeUniqueCycConstant(String startName)
   ...
   * @throws  CycApiException         if the api request results in a cyc server error
   */
  CycConstant makeUniqueCycConstant(String startName, String prefix) 
          throws CycConnectionException, CycApiException;
   ...
   * @throws  CycApiException         if the api request results in a cyc server error
   */
  void rename(CycConstant cycConstant, String newName) 
          throws CycConnectionException, CycApiException;
   ...
   * @throws  CycApiException         if the api request results in a cyc server error
   */
  void rename(CycConstant cycConstant, String newName, boolean bookkeeping, boolean transcript)
          throws CycConnectionException, CycApiException;
   ...
   * @throws  CycApiException         if the api request results in a cyc server error
   */
  Object getSymbolValue(CycSymbol cycSymbol)
          throws CycConnectionException, CycApiException;
   ...
   * @throws  CycConnectionException  if cyc server host not found on the network or the Cyc server
   *                                  cannot be found
   * @throws  CycApiException         if the api request results in a cyc server error
   */
  void setSymbolValue(CycSymbol cycSymbol, Object value)
          throws CycConnectionException, CycApiException;
  
  /**
   * Convert a CycList into an instance of its most specific type. E.g., if a CycList instance 
   * were created for <code>(#$TheFruitFn #$AppleTree)</code>, this method would convert it into a 
   * Naut instance representing the same.
   * 
   * @param   cycList  the CycList to tighten
   * @return  the cycList, converted to the most specific appropriate CycObject type
   */
