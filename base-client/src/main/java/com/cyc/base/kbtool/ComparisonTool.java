...
public interface ComparisonTool {
   ...
   */
  boolean areDisjoint(CycObject collection1, CycObject collection2) throws CycConnectionException, CycApiException;
   ...
   * @throws CycApiException if the api request results in a cyc server error
   */
  boolean areDisjoint(CycObject collection1, CycObject collection2, CycObject mt) throws CycConnectionException, CycApiException;
 ...
 otherwise false
   ...
   * @throws CycApiException if the api request results in a cyc server error
   */
  boolean areIntersecting(Fort collection1, Fort collection2) throws CycConnectionException, CycApiException;
   ...
   * @throws CycApiException if the api request results in a cyc server error
   */
  boolean areIntersecting(Fort collection1, Fort collection2, CycObject mt) throws CycConnectionException, CycApiException;
   ...
   * @return if both objects are equal EL expressions
   * 
   * @throws CycConnectionException if a data communication error occurs
   */
