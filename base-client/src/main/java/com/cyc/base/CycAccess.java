...
public interface CycAccess {
  ...
  public static CycAccess get(CycAddress server) throws CycConnectionException, CycApiException {
    return CycClient.get(server);
  }

  public static CycAccess get(CycSessionConfiguration config) 
          throws CycConnectionException, CycApiException {
    return CycClient.get(config);
  }

  public static CycAccess get(CycSession session) throws CycConnectionException, CycApiException {
    return CycClient.get(session);
  }

  public static CycAccess get(CycConnection conn) throws CycConnectionException, CycApiException {
    return CycClient.get(conn);
  }

  public static CycAccess getCurrent() throws CycConnectionException, CycApiException {
    return CycClient.getCurrent();
  }

  public static CycAccess close(CycAddress server) {
    return CycClient.close(server);
  }

  public static Set<CycAccess> closeAll() {
    return (Set) CycClient.closeAll();
  }
 ...
 deprecated, use getCycAddress().getHostName()
 ...
 deprecated, use getCycAddress().getBasePort()
  ...
  /**
   * deprecated, use getCycAddress().getHttpPort()
...
//  int importMucExpression(CycList mucExpression, String mtName) throws CycConnectionException, CycApiException;
  ...
  /**
   * Provides tools for importing KE text.
   * 
   * @return KeTextTool
   */
