...
public interface CycAccessOptions extends SessionOptions {
  ...
  /**
   * Returns the value of the Cyclist. If one has not been set, it will return null.
   *
   ...
   * assertions to new KB entities created in this session.  Setting the current Cyclist will 
   * override the default cyclist within that thread.
   *
