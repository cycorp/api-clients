...
public class TestConstants {
  ...
  public static final CycConstant CONTENT_FOR_API_TEST =
          new CycConstantImpl("ContentForAPITest", 
                  new GuidImpl("4f22375d-30aa-4b06-a25a-d05e2867dfa8"));
  ...
  @CycTerm(cycl="#$Toto-FictionalDog")
  public static final CycConstant TOTO_FICTIONAL_DOG =
          new CycConstantImpl("Toto-FictionalDog", CycObjectFactory.makeGuid(
                  "1acf70e6-f7ab-4b13-910e-504ce189b9f9"));
  ...
  @CycTerm(cycl="#$SampleComputerDatabaseSupplier-CMLS")
  public static final CycConstantImpl SAMPLE_COMPUTER_DATABASE_SUPPLIER_CMLS = new CycConstantImpl("SampleComputerDatabaseSupplier-CMLS", new GuidImpl("cf37b463-13e1-482e-8733-f729e4927c2a"));
  
   @CycTerm(cycl="#$SampleComputerDatabaseProgram-Object-CMLS")
  public static final CycConstantImpl SAMPLE_COMPUTER_DATABASE_PROGRAM_OBJECT_CMLS = new CycConstantImpl("SampleComputerDatabaseProgram-Object-CMLS", new GuidImpl("10f88fbb-877b-40e2-888b-686e439cb3dc"));
