...
public class ComparisonToolImpl extends AbstractKbTool implements ComparisonTool {
  ...
  public ComparisonToolImpl(CycAccess client) {
    super(client);
  }
  ...
  public boolean areAssertedCoextensional(Fort collection1,
    ...
    if (predicateRelates(CommonConstants.CO_EXTENSIONAL,
            ...
            collection2)) {
      return true;
    } else return predicateRelates(CommonConstants.CO_EXTENSIONAL, collection2, collection1);
  }
  ...
  public boolean areAssertedCoextensional(Fort collection1,
    ...
    if (predicateRelates(CommonConstants.CO_EXTENSIONAL,
            ...
            mt)) {
      return true;
    } else return predicateRelates(CommonConstants.CO_EXTENSIONAL, collection2, collection1, mt);
  }
  ...
  public boolean areIntersecting(Fort collection1,
    ...
    return getConverse().converseBoolean(
            "(collections-intersect? " + collection1.stringApiValue() + " "
            + collection2.stringApiValue() + " " + makeElMt_inner(mt).stringApiValue() + ")");
  }
  ...
  public boolean predicateRelates(CycConstant binaryPredicate,
    ...
    if (response[0].equals(Boolean.TRUE)) {
      if (response[1] == null) {
        return false;
      } else return response[1].toString().equals("T");
    } else {
