 ...
 * use the {@link com.cyc.baseclient.kbtool.AssertToolImpl}. To perform simple tasks,
 like renaming constants, use the {@link com.cyc.baseclient.kbtool.ObjectToolImpl}.
 * 
...
public class UnassertToolImpl extends AbstractKbTool implements UnassertTool {
  ...
  public UnassertToolImpl(CycAccess client) {
    super(client);
  }
 ...
 delete any derived assertions whose sole support is the killed term(s).
  ...
  public synchronized void kill(CycConstant[] cycConstants)
          throws CycConnectionException, CycApiException {
    for (CycConstant cycConstant : cycConstants) {
      kill(cycConstant);
    }
  }
 ...
 automatically delete any derived assertions whose sole support is the killed term(s).
  ...
  public void unassertGaf(CycList gaf,
          CycObject mt)
          throws CycConnectionException, CycApiException {
    unassertGaf(FormulaSentenceImpl.makeFormulaSentence(gaf), mt, true, true);
  }
