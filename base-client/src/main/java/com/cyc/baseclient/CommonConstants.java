...
public class CommonConstants {
  ...
  /**
   * Convenient reference to #$thereExistVars.
   */
  @CycTerm(cycl = "#$thereExistVars")
  public static final CycConstantImpl THERE_EXIST_VARS = new CycConstantImpl(
          "thereExistVars", new GuidImpl("1bcc807e-affc-44db-afc9-63fd380ab64e"));
  ...
  public static final CycConstantImpl THERE_EXIST_EXACTLY = new CycConstantImpl(
          "thereExistExactly", new GuidImpl("aa015303-dcab-11e5-84d3-005056934a1d"));
  ...
  public static final CycConstantImpl THERE_EXIST_AT_MOST = new CycConstantImpl(
          "thereExistAtMost", new GuidImpl("aa015305-dcab-11e5-84d3-005056934a1d"));
  ...
  public static final CycConstantImpl THERE_EXIST_AT_LEAST = new CycConstantImpl(
          "thereExistAtLeast", new GuidImpl("aa015304-dcab-11e5-84d3-005056934a1d"));
  ...
  @CycTerm(cycl = "#$Percent")
  public static final CycConstantImpl PERCENT = new CycConstantImpl("Percent",
          new GuidImpl("bd5892ab-9c29-11b1-9dad-c379636f7270"));

  @CycTerm(cycl = "#$SchemaObjectFn")
  public static final CycConstantImpl SCHEMA_OBJECT_FN = new CycConstantImpl("SchemaObjectFn",
          new GuidImpl("19c239b8-378c-11d6-8000-0090279a5907"));

  @CycTerm(cycl = "#$schemaIsa")
  public static final CycConstantImpl SCHEMA_ISA = new CycConstantImpl("schemaIsa",
          new GuidImpl("89c054b0-32ba-11d6-8000-0090279a5907"));
  ...
  public static final CycConstantImpl GENERIC_INSTANCE_FN = new CycConstantImpl("GenericInstanceFn",
          new GuidImpl("bff57258-9c29-11b1-9dad-c379636f7270"));
