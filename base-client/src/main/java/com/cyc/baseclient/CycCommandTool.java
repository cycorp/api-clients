...
public class CycCommandTool implements CommandTool {
   ...
   * @see com.cyc.base.connection.CycConnection#converse(java.lang.Object) 
   * @throws CycApiException if the api request results in a cyc server error
   */
  // @note Used by BOAPI.
  @Override
  ...
  protected Object[] converse(Object command)
    ...
    final Object[] result = getCycClient().converse(command);
    if (LOGGER.isDebugEnabled()) {
      LOGGER.debug(" result: {}", Arrays.asList(result));
    }
    return result;
  }
