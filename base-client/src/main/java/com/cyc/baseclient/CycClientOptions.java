...
public class CycClientOptions implements CycAccessOptions {
  ...
  /**
   * Sets the value of the default Cyclist, whose identity will be attached via #$myCreator
   * bookkeeping assertions to new KB entities created in this session. Setting the current Cyclist
   * (via {@link #setCyclistName(java.lang.String) }) will override the default cyclist within that
   * thread.
   *
  ...
  /**
   * Sets the value of the default Cyclist for this CycClient, whose identity will be attached via
   * #$myCreator bookkeeping assertions to new KB entities created in this session. Setting the
   * current Cyclist (via {@link #setCyclistName(java.lang.String) } will override this default
   * Cyclist within that thread.
   *
  ...
  /**
   * Resets the current cyclist value. If the current CycSessionConfiguration has a default Cyclist,
   * that cyclist will now become the current cyclist.
   */
  @Override
  ...
  /**
   * Returns the value of the Cyclist. Returns the value from 
   * {@link #setCyclist(com.cyc.base.cycobject.Fort) } if one has been set. Otherwise, returns the
   * default as set with {@link #setCyclist(com.cyc.base.cycobject.Fort)}. If that also has not been
   * set, return null.
   *
  ...
  @Override
  public void setShouldConvertToJavaDates(boolean performConversion) {
    shouldConvertToJavaDates = performConversion;
  }

  @Override
  public boolean getShouldConvertToJavaDates() {
    if (shouldConvertToJavaDates == null) {
      return false;
    }
    return shouldConvertToJavaDates;
  }

  @Override
  public void resetShouldConvertToJavaDates() {
    shouldConvertToJavaDates = null;
  }
