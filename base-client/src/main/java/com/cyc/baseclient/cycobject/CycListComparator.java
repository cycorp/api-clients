...
public class CycListComparator implements Comparator {
  ...
  /**
   * Compares two <tt>CycList</tt> elements, according to their string representations.
   *
   * @param o1 an Object for comparison
   * @param o2 another Object for comparison.
   * @return a negative integer, zero, or a positive integer as the first argument is less than,
   * equal to, or greater than the second.
   * @exception ClassCastException - if the arguments' types prevent them from being compared by
   * this Comparator
   */
  @Override
   ...
   * @return <tt>true</tt> only if the specified object is also a comparator and it imposes the same
