  ...
  public boolean equals(Object obj) {
    ...
    */
    if (this.iconURL != other.iconURL
            && (this.iconURL == null || !this.iconURL.equals(other.iconURL))) {
      return false;
    }
    return (this.citationString != null) 
            ? this.citationString.equals(other.citationString)
            : (other.citationString != null);
  }
