...
public class CycVariableImpl extends DefaultCycObjectImpl implements CycVariable {
   ...
   * Constructs a new <tt>CycVariable</tt> object.
   *
   * @param nameStr the <tt>String</tt> name of the <tt>CycVariable</tt>.
   */
   ...
   *
   * <p>NOTE: Comparing a CycVariable to a CycSymbol gives the right behavior iff the names are equal.
   * 
