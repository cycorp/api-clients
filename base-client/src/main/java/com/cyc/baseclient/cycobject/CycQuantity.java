...
/**
 * Represents a quantity or range with a Fort unit of measure, a minimum numeric value, and a 
 * maximum numeric value.
 *
 * @version $Id: CycQuantity.java 176591 2018-01-09 17:27:27Z nwinant $
 * @author David Baxter
 */
public class CycQuantity implements Comparable<CycQuantity> {
   ...
   * 
   * <p>Deprecated: Use CycNaut version.
   * 
   * @param cycList
   * @return a new CycQuantity
   */
  @Deprecated
