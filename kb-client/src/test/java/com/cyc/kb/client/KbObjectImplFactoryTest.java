...
//    FormulaSentence istSentence = FormulaSentenceImpl.makeFormulaSentence("(ist LogicalTruthMt (isa Collection Collection))");
    CycAccess cyc = CycAccessManager.getCurrentAccess();
    FormulaSentence cycSentence = FormulaSentenceImpl.makeFormulaSentence(cyc, "(isa Collection Collection)");
  ...
  public void testRuleCanonicalizationOKForCaches() throws SessionException, KbException, UnknownHostException, IOException, Exception {
    ...
    FormulaSentence cycSentence = FormulaSentenceImpl.makeFormulaSentence(cyc, "(implies (and "
    ...
    FormulaSentence cycSentence2 = FormulaSentenceImpl.makeFormulaSentence(cyc, "(implies (and "
