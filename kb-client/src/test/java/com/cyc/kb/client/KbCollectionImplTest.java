...
/*
 * #%L
 * File: KbCollectionImplTest.java
 * Project: KB Client
 * %%
...
public class KbCollectionImplTest {
  
  private static final Logger LOG = LoggerFactory.getLogger(KbCollectionImplTest.class);
  ...
  public void testToNlString() throws KbTypeException, CreateException, SessionException {
    ...
    KbCollection temporalThing = KbCollection.get("TemporalThing");
  ...
  public void testGetMinCol() throws KbException {
    ...
    List<KbCollection> l = new ArrayList<>();
    l.add(expected_min);
    l.add(somegenls);
  ...
  public void testAllGeneralizations() throws KbException {
    ...
    LOG.debug("All Generalizations: " + ags);
