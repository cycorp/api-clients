...
/*
 * #%L
 * File: KbIndividualImplTest.java
 * Project: KB Client
 * %%
...
public class KbIndividualImplTest {
  ...
  public void testToNlString() throws KbTypeException, CreateException, SessionException {
    ...
    KbIndividual WilliamHenryHarrison = (KbIndividual) Cyc.getKbObject("WilliamHenryHarrison");
  ...
  public void testFindOrCreate_String_String_String() throws Exception {
    ...
    // Test for find
    String nameOrId1 = "AlbertEinstein";
    ContextImpl.findOrCreate("WebSearchDataMt"); // We are using this getContextService as a string
