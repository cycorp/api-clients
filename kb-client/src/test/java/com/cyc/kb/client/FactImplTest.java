...
public class FactImplTest {
  ...
  public void testFactCycObject() throws Exception {
    ...
    FormulaSentence cfs = FormulaSentenceImpl.makeFormulaSentence(cyc, "(isa Plane-APITest CommercialAircraft)");
  ...
  public void testConstructAssertion() throws KbException {
    ...
    try {
      ...
      KbIndividual expectedDate = KbIndividual.get("(MinuteFn 5 (HourFn 8 (DayFn 15 (MonthFn March (YearFn 2014)))))");
      KbIndividual assertedDate = wellA.<KbIndividual>getArgument(2);
      assertEquals(expectedDate, assertedDate);
  ...
  public void testFactFactories() throws KbTypeException, CreateException, ParseException, DeleteException {
    ...
    // Get based on formula and getContextService strings
  ...
  public void testAddList_SentenceWithStrings() throws KbException {
    ...
    final BinaryPredicate flightDestinationList = BinaryPredicate.get("flightDestinationList");
    final KbIndividual flyingAPlaneAPITest = KbIndividualImpl.get("FlyingAPlane-APITest");
    final List<String> cityStrings = new ArrayList<>();
    ...
    //this test is based on outdated assumptions, namely that new SentenceImpl won't try to do any interpretation
    //on the arguments it's given.  It now does interpretation on these arguments.  It's an open question what happens
    //if you use a string that doesn't convert to a Cyc term, and that @todo should be added as a different test, 
  ...
  public void testAddList_SentenceWithTerms() throws KbException {
    ...
    final List<KbIndividual> cityTerms = new ArrayList<>();
  ...
  public void testAddSet() throws KbException {
    ...
    Set<KbObjectImpl> ls = new HashSet<>();
  ...
  public void testAddAndGetSentence() throws KbException {
    ...
    KbPredicateImpl meaningSentenceOfSchema = KbPredicateImpl.get("meaningSentenceOfSchema");
    List<Object> l = new ArrayList<>();
    l.add(KbPredicateImpl.get("isa"));
    l.add(i);
    l.add(meaningSentenceOfSchema);
    Sentence s = new SentenceImpl(l.toArray());
    
    meaningSentenceOfSchema.addFact(ContextImpl.get("UniversalVocabularyMt"), i, s);
    
    Collection<Fact> lfs = meaningSentenceOfSchema.getFacts(i, 1, ContextImpl.get("UniversalVocabularyMt"));
